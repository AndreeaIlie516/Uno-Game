...
public class UnoDeck {
    ...
    public void shuffle() {
        ...
        for (int i = 0; i < cards.length; i++) {
            int randomValue = i + random.nextInt(cardsInDeck - i); //check here!!!!
    ...
    public UnoCard drawCard() throws IllegalArgumentException {
        if (isEmpty()) {
            throw new IllegalArgumentException("Cannot draw a card sincer there are no cards in the deck.");
        }
    ...
    public ImageIcon drawCardImage() throws IllegalArgumentException {
        if (isEmpty()) {
            throw new IllegalArgumentException("Cannot draw a card sincer the deck is empty.");
        }
